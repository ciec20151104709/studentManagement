...
namespace student
{
    public partial class StudentMainForm : Form
    {
        ...
        {
            this.Text = "欢迎你、学号为:  " + Sno + "  的同学";
        }

        private void button2_Click(object sender, EventArgs e)
        {
            string constr = "server=111.231.69.100;port=3306;uid=linge;password=123456;Database=linge";
            string cmdstr = string.Format("select Cname from SC,Course where SC.Sno='{0}' AND SC.Cno=Course.Cno", Sno);
        ...
        {
            SelectNewCourse S1 = new SelectNewCourse(this.Sno);
            S1.Show();
        }
    }
}
